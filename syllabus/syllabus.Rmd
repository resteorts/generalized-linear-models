...
|----------------|----------------|----------------|-------------------------|
| Instructor         | Professor Rebecca Steorts | after class | Old Chem 208/zoom |
| Teaching Assistant | Devarpita Bag             |  Tu/Th 5:00 -- 6:00 PM  | zoom        |

## Course info

|          | Day       | Time               | Location            |
|----------|-----------|--------------------|---------------------|
| Lectures | Tu & Thurs | 11:45 am - 1:00 pm | Perkins 127            |
| Lab      | Friday    | 11:45 am - 1:00 pm  | Old Chemistry 001       |

## Zoom Information

We will utilize the following zoom link for unscheduled office hours, zoom office hours, or other emergent issues as needed regarding any classes. Zoom Meeting/Lab ID: 965 8009 0278. This is posted on canvas for security reasons.
...
All lecture notes, assignment instructions, an up-to-date schedule, and other course materials may be found on the course website, <https://github.com/resteorts/generalized-linear-models>
...
If you are unsure if the use of a particular resource complies with the academic honesty policy, please ask myself or a teaching assistant.
...
There will be no late extensions on any assignments, unless there are extenuating circumstances. Please make sure that you stay up to date on the class and assignments by attending class or obtaining notes if you miss class. Deadlines for assignments will be posted on Gradescope. It is recommended that you start assignments early and get help if needed. 

If there are circumstances that are having a longer-term impact on your academic performance, please feel free to contact myself or your academic dean, as we can be a resource. Please let me know if you need help contacting your academic dean.
