...
3. Verify using a grid-search that your solution matches to the calculus based one. Assume $\sum_{i=1}^n x_i = 500.$ and $n=100.$ In this example, you should find that $\lambda \approx 5.$
