...
::: question
Observe that $n$ does not matter here. The order of the fouls does not matter either.  
:::
...
On your own, fill in the table and verify that the likelihood is indeed correct. 

## A and B

**A** = \textcolor{blue}{$(p_{H\vert N})(1- p_{H\vert H Bias})(1 - p_{H\vert N})$}

Foul1: H -- Given there is no foul in both teams (N), the first foul is on the home team (H)

Foul2: V -- Given there is one more prior foul on the home team (H Bias), the second foul is on the visiting team (V)

Foul3: V -- Given there is one foul in both teams (N), the third foul is on the visiting team (V)

**B** = \textcolor{blue}{$(1- p_{H\vert N})(p_{H\vert V Bias})(p_{H\vert N})$}

Foul1: V -- Given there is no foul in both teams (N), the first foul is on the visiting team (V)

Foul2: H -- Given there is one more prior foul on the visiting team (V Bias), the second foul is on the home team (H)

Foul3: H -- Given there is one foul in both teams (N), the third foul is on the home team (H)

## Likelihood

After filling in **A** and **B**, we multiply all the likelihood contributions (since the n = 30 games are independent from one another) to obtain the total likelihood.
