...
1. Quiz 1 has been extended for students that had an excused issue. Due date: Thurs. Jan 15 5PM. 
...
3a.) Consider Equation (1.3) in Section 1.6.3. Show why we have to be sure to say “holding year constant”, “after adjusting for year”, or an equivalent statement, when interpreting $\beta_2.$
