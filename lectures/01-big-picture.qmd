...
-   Every assignment is written in an Rmarkdown document (you can use Quarto instead if you prefer). 

-   You'll have a template document to start with

-   If you have used Rmarkdown and Quarto, think about what the similarities and differences are between them. 
