...
The variable `arrival mode` has two possible values: ambulance and walk-in. Describe the effect of arrival mode (covariate) on waiting time (three levels). Note: The baseline category is walk-in.

- Arrival mode has two possible values: "ambulance" and "walk-in".

- Baseline category is "walk-in."
...
- Thus, arriving by ambulance (as opposed to a walk-in) significantly decreases the likelihood of being classified in the longer waiting time groups. 
